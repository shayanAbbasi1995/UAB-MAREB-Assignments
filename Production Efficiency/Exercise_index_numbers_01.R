...
write.xlsx(Prod_index_pop, file = "Sol_Prod_index_pop.xlsx", colNames = TRUE, rowNames = TRUE)
...
write.xlsx(Prices_index_pop, file = "Sol_Prices_index_pop.xlsx", colNames = TRUE, rowNames = TRUE)
